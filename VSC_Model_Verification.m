...
P_ref_step  = -1000;    % Active power set-point after step 2 (W)
P_step_time = 1;        % Active power step time (s)

%% Simulink simulation %%
sim_time = 3;

avg_model = sim('Simulink Models/VSC_Model_Verification_AVG',...
            'SimulationMode','normal',...
            'SaveOutput','on','OutputSaveName','yout',...
            'SaveFormat', 'Dataset');

switch_model = sim('Simulink Models/VSC_Model_Verification_Switching_Devices',...
            'SimulationMode','normal',...
            'SaveOutput','on','OutputSaveName','yout',...
            'SaveFormat', 'Dataset');
