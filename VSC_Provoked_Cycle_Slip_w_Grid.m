...
L_grid  = 2.5e-3;             % AC grid - VSC transmission line inductance (H)
...
avg_model = sim('Simulink Models/VSC_Provoked_Cycle_Slip_AVG_w_Grid',...
            'SimulationMode','normal',...
            'SaveOutput','on','OutputSaveName','yout',...
            'SaveFormat', 'Dataset');
        
if all_sim_flag == 1
    switch_model = sim('Simulink Models/VSC_Provoked_Cycle_Slip_Switching_Devices_w_Grid',...
                'SimulationMode','normal',...
                'SaveOutput','on','OutputSaveName','yout',...
                'SaveFormat', 'Dataset');
end
...
avg_model_2 = sim('Simulink Models/VSC_Provoked_Cycle_Slip_AVG_w_Grid',...
            'SimulationMode','normal',...
            'SaveOutput','on','OutputSaveName','yout',...
            'SaveFormat', 'Dataset');
        
if all_sim_flag == 1
    switch_model_2 = sim('Simulink Models/VSC_Provoked_Cycle_Slip_Switching_Devices_w_Grid',...
                'SimulationMode','normal',...
                'SaveOutput','on','OutputSaveName','yout',...
                'SaveFormat', 'Dataset');
end
...
avg_model_3 = sim('Simulink Models/VSC_Provoked_Cycle_Slip_AVG_w_Grid',...
            'SimulationMode','normal',...
            'SaveOutput','on','OutputSaveName','yout',...
            'SaveFormat', 'Dataset');
...
if all_sim_flag == 1
    sim_time = 3;
    switch_model_3 = sim('Simulink Models/VSC_Provoked_Cycle_Slip_Switching_Devices_w_Grid',...
                'SimulationMode','normal',...
                'SaveOutput','on','OutputSaveName','yout',...
                'SaveFormat', 'Dataset');
end
